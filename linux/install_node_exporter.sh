#!/bin/bash
# Use
# wget https://raw.githubusercontent.com/biko-solutions/monitoring/main/linux/install_node_exporter.sh && sudo chmod +x install_node_exporter.sh && sudo ./install_node_exporter.sh && rm install_node_exporter.sh
